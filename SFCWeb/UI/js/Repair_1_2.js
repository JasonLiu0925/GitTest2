...
function frmEvent() { //form event function
    $('#searchBtn1').on('click', function () {
        ...
        // if(apiurl=='web_sign_in_out_data' || apiurl=='web_maintain_data' ){
...
function createGrid(id) { //create jagrid
    ...
    if(getUrlVars()['type']=='Repair_1_3'){
        gridList[id].gridDefinitionUrl=invokeURL + $('#selcitem1').val();
        gridList[id].colAPI=$('#selcitem1').val()
    ...
    console.log('gridDefinitionUrl = '+gridList[id].gridDefinitionUrl);
