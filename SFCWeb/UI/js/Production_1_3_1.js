...
var gridList = [{ //grid初始化參數
    ...
    pager: '#jqGrid1Pager',
    shrinkToFit: true,
    gridDefinitionUrl: invokeURL + 'Production_1_3_1',//apiurl P
    
    colAPI: 'solder_paste_status', //set colModel index
    ...
    pager: '#jqGrid1Pager',
    shrinkToFit: true,
    gridDefinitionUrl: invokeURL + 'Production_1_3_1_warmup',//apiurl P
    ...
    pager: '#jqGrid1Pager',
    shrinkToFit: true,
    gridDefinitionUrl: invokeURL + 'Production_1_3_1_stockout',//apiurl P
    ...
    pager: '#jqGrid1Pager',
    shrinkToFit: true,
    gridDefinitionUrl: invokeURL + 'Production_1_3_1_scrap',//apiurl P
