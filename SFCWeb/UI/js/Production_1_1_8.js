...
var gridList = [{ //grid初始化參數
    ...
    pager: '#jqGrid1Pager',
    shrinkToFit: true,
    gridDefinitionUrl: invokeURL + 'Production_1_1_8',//apiurl P
    
    colAPI: 'Production_1_1_8A', //set colModel index
    ...
    colAPI: 'Production_1_1_8B', //set colModel index
    fixedColFDb: false, //set db
    gridDefPostData: {
    ...
    colAPI: 'Production_1_1_8C', //set colModel index
    fixedColFDb: false, //set db
    gridDefPostData: {
