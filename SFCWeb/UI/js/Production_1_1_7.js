...
var gridList = [{ //grid初始化參數 0
    ...
    pager: '#jqGrid1Pager',
    shrinkToFit: true,
    gridDefinitionUrl: invokeURL + 'Production_1_1_7',//apiurl P
...
function frmEvent() { //form event function
    ...
    $('#searchBtn1').on('click', function () {
        ...
        let result = ajaxGetData(invokeURL + "Production_1_1_7_chk", postData);
