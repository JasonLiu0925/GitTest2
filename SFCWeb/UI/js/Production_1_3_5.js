...
var gridList = [{ //grid初始化參數 0
    ...
    colAPI: 'Production_1_3_5', //set colModel index
    ...
    ondblClickRow:function(rowid,iRow,iCol,e){
        ...
        console.log('JA001',$.trim(grid.getRowData()[curRowNum-1]["JA001"])); //取得加工順序
        JA001 = $.trim(grid.getRowData()[curRowNum-1]["JA001"]); 
    ...
    colAPI: 'Production_1_3_5C', //set colModel index
    ...
    colAPI: 'Production_1_3_5D', //set colModel index
    fixedColFDb: false, //set db
    gridDefPostData: {
    ...
    colAPI: 'Production_1_3_5B', //set colModel index
    fixedColFDb: false, //set db
    gridDefPostData: {
