...
var gridList = [{ //grid初始化參數
    ...
    pager: '#jqGrid1Pager',
    shrinkToFit: true,
    gridDefinitionUrl: invokeURL + 'Yield_1_8_1A',//apiurl P
    
    colAPI: 'Yield_1_8_1A', //set colModel index
    ...
    pager: '#jqGrid2Pager',
    shrinkToFit: true,
    gridDefinitionUrl: invokeURL + 'Yield_1_8_1B',//apiurl P
    
    colAPI: 'Yield_1_8_1B', //set colModel index
    fixedColFDb: false, //set db
    gridDefPostData: {
    ...
    pager: '#jqGrid3Pager',
    shrinkToFit: true,
    gridDefinitionUrl: invokeURL + 'Yield_1_8_1C',//apiurl P
    
    colAPI: 'Yield_1_8_1C', //set colModel index
    fixedColFDb: false, //set db
    gridDefPostData: {
    ...
    pager: '#jqGrid4Pager',
    shrinkToFit: true,
    gridDefinitionUrl: invokeURL + 'Yield_1_8_1D',//apiurl P
    
    colAPI: 'Yield_1_8_1D', //set colModel index
    fixedColFDb: false, //set db
    gridDefPostData: {
    ...
    pager: '#jqGrid5Pager',
    shrinkToFit: true,
    gridDefinitionUrl: invokeURL + 'Yield_1_8_1E',//apiurl P
    
    colAPI: 'Yield_1_8_1E', //set colModel index
    fixedColFDb: false, //set db
    gridDefPostData: {
